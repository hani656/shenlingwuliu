<script setup>
  ...
  async function getTaskDetail(id) {
    ...
    if (code !== 200) return uni.utils.toast('获取详情失败！')
    // 数据渲染
    ...
    <scroll-view scroll-y class="task-detail">
      <view class="scroll-view-wrapper">
        <view class="basic-info panel">
          ...
          <view class="info-list">
            ...
            <template v-if="taskDetail.status >= 2">
              <view style="margin: 20rpx 0; border-bottom: 1rpx solid #f4f4f4">
              </view>
        ...
        <view v-if="taskDetail.status >= 2" class="panel pickup-info">
          ...
          <view class="pictures">
            <image
              v-for="receipt in taskDetail.cargoPickUpPictureList"
              :key="receipt.url"
              class="picture"
              :src="receipt.url"
            ></image>
          ...
          <view class="pictures">
            <image
              v-for="goods in taskDetail.cargoPictureList"
              :key="goods.url"
              class="picture"
              :src="goods.url"
            ></image>
        ...
        <view v-if="taskDetail.status >= 4" class="delivery-info panel">
